package PrvKolokviumVezbi.TenthExercise;
...
class BiggerThanEvaluator<T extends Comparable<T>> implements IEvaluator<T> {
    @Override
...
class EqualToEvaluator<T extends Comparable<T>> implements IEvaluator<T> {
    @Override
    public boolean evaluate(T a, T b) {
        return a.compareTo(b) == 0;
    }
...
class NotEqualToEvaluator<T extends Comparable<T>> implements IEvaluator<T> {
    @Override
    public boolean evaluate(T a, T b) {
        return a.compareTo(b) != 0;
    }
...
class LesserThanEvaluator<T extends Comparable<T>> implements IEvaluator<T> {
    @Override
    public boolean evaluate(T a, T b) {
        return a.compareTo(b) < 0;
    }
